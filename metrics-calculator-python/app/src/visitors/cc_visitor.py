...
class CCNodeVisitor(ast.NodeVisitor):
    ...
    def __init__(self, class_obj):
        ...
        # The value of cc will be increased for every node that can change the program flow
        self.cc = 0
    ...
    # We don't need to check for else in loop because from there the program will execute sequentially
    # each time after the completion of the loop
    ...
    # We don't need to add else because in else we haven't check
