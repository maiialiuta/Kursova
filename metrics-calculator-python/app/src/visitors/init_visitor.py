import ast
from app.src.metrics.categories.cohesion_category import CohesionCategory
from app.src.metrics.categories.coupling_category import CouplingCategory
from app.src.metrics.categories.qmood_category import QMOODCategory
from app.src.metrics.categories.size_category import SizeCategory
from app.src.metrics.categories.complexity_category import ComplexityCategory
from app.src.entities.class_entity import Class
from app.src.visitors.class_attr_visitor import ClassAttrNodeVisitor
...
class InitCommonsNodeVisitor(ast.NodeVisitor):
    ...
    def visit_ClassDef(self, node):
        ...
        for child in node.body:
            ...
            # In else, we are outside the methods, so we will visit this part to get the class attributes
