class Class:
    ...
    def __init__(self, class_name: str, python_file_obj, class_ast_node, cohesion_category_metrics,
                 complexity_category_metrics, coupling_category_metrics, qmood_category_metrics, size_category_metrics):
        # The name of the class node we're checking
        ...
        self.hierarchy = -1
        # Init objects that will keep the software quality metrics for the class
